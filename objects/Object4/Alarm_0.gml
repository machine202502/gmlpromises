...
//_future.once(function(_resolved, _rejected) {
//	show_debug_message("");
...
//async_timeout(2500, "world").once(function(_resolved) {
//	show_debug_message("timeout 2");
//	show_debug_message(_resolved);
		
//	self.future.once(function(_resolved) {
//		show_debug_message("timeout repeat");
//		show_debug_message(_resolved);
//	});
//});

//async_timeout(1500).subscribe(function(_resolved) {
//	show_debug_message("");
//	show_debug_message("timeout 2");
//	show_debug_message(_resolved);
//});
//async_timeout(1500).subscribe(undefined, function(_rejected) {
//	show_debug_message("");
